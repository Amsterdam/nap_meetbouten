...
node {
    ...
    stage "Build"
        ...
        def image = docker.build("admin.datapunt.amsterdam.nl:5000/datapunt/nap:${BRANCH}", "web")
        image.push()
    ...
    stage "Deploy"
        ...
        slackSend message: "Problem while building Atlas NAP Meetbouten service: ${err}",
                channel: '#ci-channel'
