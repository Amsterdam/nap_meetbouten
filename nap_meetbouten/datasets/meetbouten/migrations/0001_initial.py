    ...
    operations = [
            ...
            fields=[
                ...
                ('hoogte_nap',
                 models.DecimalField(decimal_places=4, max_digits=7,
                                     null=True)),
                ('zakking_cumulatief',
                 models.DecimalField(decimal_places=13, max_digits=20,
                                     null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('referentiepunt',
                 models.ForeignKey(to='meetbouten.Referentiepunt')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                through='meetbouten.ReferentiepuntMeting',
                to='meetbouten.Referentiepunt', related_name='metingen'),
        ),
    ]
